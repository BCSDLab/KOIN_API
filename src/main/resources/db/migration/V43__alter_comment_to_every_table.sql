ALTER TABLE `koin`.`versions`
    ...
    CHANGE COLUMN `version` `version` VARCHAR(20) NOT NULL COMMENT '버전 명 (예시 : 1.1.0)' ,
    CHANGE COLUMN `type` `type` VARCHAR(20) NOT NULL COMMENT '타입 (예시 : android)' ,
...
ALTER TABLE `koin`.`users`
    ...
    CHANGE COLUMN `phone_number` `phone_number` VARCHAR(20) NULL DEFAULT NULL COMMENT '휴대 전화 번호' ,
    CHANGE COLUMN `user_type` `user_type` VARCHAR(20) NOT NULL COMMENT '유저 타입(Students or Owners)' ,
...
ALTER TABLE `koin`.`members`
    ...
    CHANGE COLUMN `position` `position` VARCHAR(20) NOT NULL COMMENT '직급' ,
...
ALTER TABLE `koin`.`lost_items`
    ...
    CHANGE COLUMN `phone` `phone` VARCHAR(20) NULL DEFAULT NULL COMMENT '전화 번호' ,
...
ALTER TABLE `koin`.`lands`
    ...
    CHANGE COLUMN `size` `size` VARCHAR(20) NULL DEFAULT NULL COMMENT '방 크기' ,
    CHANGE COLUMN `room_type` `room_type` VARCHAR(20) NULL DEFAULT NULL COMMENT '원룸 종류' ,
    CHANGE COLUMN `latitude` `latitude` VARCHAR(20) NULL DEFAULT NULL COMMENT '위도' ,
    CHANGE COLUMN `longitude` `longitude` VARCHAR(20) NULL DEFAULT NULL COMMENT '경도' ,
    CHANGE COLUMN `phone` `phone` VARCHAR(20) NULL DEFAULT NULL COMMENT '전화번호' ,
    CHANGE COLUMN `image_urls` `image_urls` TEXT NULL DEFAULT NULL COMMENT '이미지 링크' ,
    CHANGE COLUMN `address` `address` TEXT NULL DEFAULT NULL COMMENT '주소' ,
    CHANGE COLUMN `description` `description` TEXT NULL DEFAULT NULL COMMENT '세부 사항' ,
    ...
    CHANGE COLUMN `charter_fee` `charter_fee` VARCHAR(20) NULL DEFAULT NULL COMMENT '전세' ,
...
ALTER TABLE `koin`.`event_articles`
    ...
    CHANGE COLUMN `title` `title` VARCHAR(20) NOT NULL COMMENT '제목' ,
