...
public class MembersResponse {
    @ApiModelProperty(notes = "조건에 해당하는 총 회원의 수", example = "57")
    private Integer total_count;

    @ApiModelProperty(notes = "조건에 해당하는 회원 중에 현재 페이지에서 조회된 수", example = "10")
    private Integer current_count;

    @ApiModelProperty(notes = "조건에 해당하는 회원들을 조회할 수 있는 최대 페이지", example = "6")
    private Integer total_page;

    @ApiModelProperty(notes = "현재 페이지", example = "2")
    private Integer current_page;

    @ApiModelProperty(notes = "회원 정보 리스트")
