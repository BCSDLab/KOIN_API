...
public class KakaoBot {
    ...
    private static final String[][] shuttleFromKoreatechVacation = {
            { // 월요일
                    "14:00",
                    "18:10",
            },
    ...
    private static final String[][] shuttleFromKoreatechSemester = {
            { // 월요일
                    "09:10",
                    "11:00",
                    "14:00",
    ...
    private static final String[][][] shuttleFromKoreatech = {
            shuttleFromKoreatechSemester,
            shuttleFromKoreatechVacation
    };


    //방학기간
    private static final String[][] shuttleFromTerminalVacation = {
            { // 월요일
                    "08:00",
                    "14:25"
            },
    ...
    //통학기간
    private static final String[][] shuttleFromTerminalSemester = {
            { // 월요일
                    "08:00",
                    "10:10",
                    "11:25",
    ...
    private static final String[][][] shuttleFromTerminal = {
            shuttleFromTerminalSemester,
            shuttleFromTerminalVacation
    };


    //방학기간
    private static final String[][] shuttleFromStationToKoreatechVacation = {
            { // 월요일
                    "08:05",
                    "14:30"
            },
    ...
    //통학기간
    private static final String[][] shuttleFromStationToKoreatechSemester = {
            { // 월요일
                    "08:05",
                    "10:15",
                    "11:30",
    ...
    private static final String[][][] shuttleFromStationToKoreatech = {
            shuttleFromStationToKoreatechSemester,
            shuttleFromStationToKoreatechVacation
    };



    //방학기간
    private static final String[][] shuttleFromStationToTerminalVacation = {
            { // 월요일
            },
            { // 화요일
            },
    ...
    //통학기간
    private static final String[][] shuttleFromStationToTerminalSemester = {
            { // 월요일
                    "09:30",
                    "15:20"
            },
    ...
    private static final String[][][] shuttleFromStationToTerminal = {
            shuttleFromStationToTerminalSemester,
            shuttleFromStationToTerminalVacation
    };



    private static final Map<String, Object> shuttleTimeTables = new HashMap<String, Object>() {{
        put("koreatech", shuttleFromKoreatech[flag]);
        put("terminal", shuttleFromTerminal[flag]);
    }};
    ...
    public static void searchShuttleTime(String departEng, String arrivalEng, StringBuilder resultNow, StringBuilder resultNext) throws ParseException {
        ...
        if (!departEng.equals("station")) { // 출발지가 천안역이 아니라면 ?
            ...
            shuttleTimeTable = arrivalEng.equals("koreatech") ? shuttleFromStationToKoreatech[flag][dayType] : shuttleFromStationToTerminal[flag][dayType];
        // 도착지에 따라 다른 시간표 가져옴
